...
<div class="ve-chung-toi">
    ...
    <div class="main-content-page">
        ...
        if (have_posts()) {
            while (have_posts()) {
                the_post();
                // Bắt đầu một div để bao quanh mỗi bài viết
                ...
                if (has_post_thumbnail()) {
                    ...
                    the_post_thumbnail('medium'); // Thay 'medium' bằng kích thước ảnh mong muốn
                    echo '</div>';
                }
                ...
                // Kết thúc div của mỗi bài viết
                echo '</div>'; // Close custom-post div
            }
        }
        ?>
    </div>
